...
export function ReportLostPage() {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, height: '100%' }}>
      ...
      <div style={{ flex: 1 }}>
        <div style={{ maxWidth: '100rem', marginLeft: 'auto', marginRight: 'auto', display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '2rem', padding: isMobile ? '1rem 1rem 6rem' : '1.5rem 2rem 6rem' }}>
          ...
          <aside style={{ width: isMobile ? '100%' : '20rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', flexShrink: 0, position: isMobile ? 'static' : 'sticky', top: '2rem', height: 'fit-content' }}>
