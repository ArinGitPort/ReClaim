...
export function MissingItemsPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <AdminPageHeader 
        title="Missing Items" 
        subtitle="Monitor and verify incoming student lost reports against system records." 
      />
      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: '2rem', alignItems: 'flex-start' }}>
        <div style={{ flex: '0 0 24rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <AdminSearchFilterBar>
            <div style={{ backgroundColor: '#FFFFFF', padding: '1rem', borderRadius: '0.75rem', border: '1px solid #E2E8F0', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)', display: 'flex', flexDirection: 'column', gap: '0.75rem', flex: 1 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
            ...
            {canReviewReport ? (
              <div style={{ 
                ...
                <Button disabled={isUpdating} onClick={() => onUpdateStatus("REJECTED")} variant="outline" style={{ 
                  flex: 1, 
                  height: '3rem', 
                  backgroundColor: '#FFFFFF', 
