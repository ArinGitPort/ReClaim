...
export function Sidebar() {
  ...
  const asideStyle: React.CSSProperties = {
    ...
    zIndex: 20,
    height: '100%', // Constant full height in viewport-fixed layout
  ...
  return (
    <aside style={asideStyle}>
      {/* App Title Header */}
        ...
        <div style={{ padding: '0.75rem', borderTop: '1px solid rgba(255, 255, 255, 0.1)', display: 'flex', flexDirection: 'column', gap: isCollapsed ? '0.75rem' : '0.25rem', flexShrink: 0, overflowX: 'hidden' }}>
          <SidebarItem 
            to="/office" 
