      ...
      <header style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '0.75rem' : '1.5rem', flex: 1, minWidth: 0 }}>
            <Link to={backLink} style={{ color: '#64748B', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.875rem', fontWeight: '600', textDecoration: 'none', flexShrink: 0 }}>
              <ArrowLeft style={{ width: '1rem', height: '1rem' }} />
              {!isMobile && backLabel}
            </Link>
            <div style={{ height: '1.5rem', width: '1px', backgroundColor: '#E2E8F0', display: isMobile ? 'none' : 'block' }}></div>
            <h1 style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '0.5rem' : '1rem', flexShrink: 0 }}>
            ...
            {!isMobile && <div style={{ height: '2rem', width: '1px', backgroundColor: '#E2E8F0' }}></div>}

            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', paddingLeft: isMobile ? '0' : '0.5rem' }}>
              {!isMobile && (
